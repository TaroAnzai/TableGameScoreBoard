...
export const getApiAdminGroups = (
 ...
 options?: SecondParameter<typeof customFetchAdmin>,signal?: AbortSignal
) => {
...
export const getGetApiAdminGroupsQueryOptions = <TData = Awaited<ReturnType<typeof getApiAdminGroups>>, TError = ErrorResponse | DefaultErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminGroups>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
) => {
...
export function useGetApiAdminGroups<TData = Awaited<ReturnType<typeof getApiAdminGroups>>, TError = ErrorResponse | DefaultErrorResponse>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminGroups>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
/**
 * @summary すべてのグループを取得
...
export const getDeleteApiAdminGroupsGroupKeyMutationOptions = <TError = ErrorResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiAdminGroupsGroupKey>>, TError,{groupKey: string}, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
...
export const getGetApiAdminContactsQueryOptions = <TData = Awaited<ReturnType<typeof getApiAdminContacts>>, TError = ErrorResponse | DefaultErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminContacts>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
) => {
...
export function useGetApiAdminContacts<TData = Awaited<ReturnType<typeof getApiAdminContacts>>, TError = ErrorResponse | DefaultErrorResponse>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminContacts>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export function useGetApiAdminContactsContactId<TData = Awaited<ReturnType<typeof getApiAdminContactsContactId>>, TError = ErrorResponse | DefaultErrorResponse>(
 contactId: number, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminContactsContactId>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
...
export const getPatchApiAdminContactsContactIdMutationOptions = <TError = ErrorResponse | UnprocessableEntityResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof patchApiAdminContactsContactId>>, TError,{contactId: number;data: ContactUpdate}, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
...
export const getDeleteApiAdminContactsContactIdMutationOptions = <TError = DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteApiAdminContactsContactId>>, TError,{contactId: number}, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
...
export const getPostApiAdminLoginMutationOptions = <TError = ErrorResponse | UnprocessableEntityResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiAdminLogin>>, TError,{data: AdminLogin}, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
): UseMutationOptions<Awaited<ReturnType<typeof postApiAdminLogin>>, TError,{data: AdminLogin}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof postApiAdminLogin>>, {data: AdminLogin}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiAdminLoginMutationError = ErrorResponse | UnprocessableEntityResponse | DefaultErrorResponse

    export const usePostApiAdminLogin = <TError = ErrorResponse | UnprocessableEntityResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiAdminLogin>>, TError,{data: AdminLogin}, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getPostApiAdminLogoutMutationOptions = <TError = ErrorResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiAdminLogout>>, TError,void, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
...
const {mutation: mutationOptions, request: requestOptions} = options ?
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type PostApiAdminLogoutMutationResult = NonNullable<Awaited<ReturnType<typeof postApiAdminLogout>>>
    
    export type PostApiAdminLogoutMutationError = ErrorResponse | DefaultErrorResponse

    export const usePostApiAdminLogout = <TError = ErrorResponse | DefaultErrorResponse,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postApiAdminLogout>>, TError,void, TContext>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const getGetApiAdminMeQueryOptions = <TData = Awaited<ReturnType<typeof getApiAdminMe>>, TError = ErrorResponse | DefaultErrorResponse>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminMe>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetApiAdminMeQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getApiAdminMe>>> = ({ signal }) => getApiAdminMe(requestOptions, signal);

      

      

   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getApiAdminMe>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetApiAdminMe<TData = Awaited<ReturnType<typeof getApiAdminMe>>, TError = ErrorResponse | DefaultErrorResponse>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminMe>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetApiAdminMe<TData = Awaited<ReturnType<typeof getApiAdminMe>>, TError = ErrorResponse | DefaultErrorResponse>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getApiAdminMe>>, TError, TData>>, request?: SecondParameter<typeof customFetchAdmin>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
